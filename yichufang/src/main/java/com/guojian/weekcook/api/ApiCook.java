...
public interface ApiCook {
    ...
    @Headers("Authorization:APPCODE d8da87a316f745b1b7b413d910a1ac72")
    @GET("detail")
    Observable<CookDetailBean> getDataById(@Query("id") int id);
    ...
    @Headers("Authorization:APPCODE d8da87a316f745b1b7b413d910a1ac72")
    @GET("search")
    Observable<CookListBean> getDataByKeyword(@Query("keyword") String keyword, @Query("num") int num, @Query("start") int start);
    ...
    @Headers("Authorization:APPCODE d8da87a316f745b1b7b413d910a1ac72")
    @GET("byclass")
    Observable<CookListBean> getDataByClassId(@Query("classid") int classid, @Query("num") int num, @Query("start") int start);
}
